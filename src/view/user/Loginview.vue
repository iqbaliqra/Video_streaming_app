<template>
  <div class="w-full md:w-1/3 bg-gray-800/90 backdrop-blur-lg rounded-xl p-8 border border-gray-700/60 shadow-2xl">
    <div>
    ...
    <form @submit.prevent="signInWithEmail" class="space-y-6">
      ...
      <div>
        <button 
          type="submit" 
          :disabled="isLoading"
          class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-lg font-medium text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all"
    ...
    <button 
      ...
      class="w-full flex items-center justify-center gap-2 py-2 px-4 border border-gray-600 rounded-lg shadow-sm bg-gray-700 text-sm font-medium text-gray-300 hover:bg-gray-600 transition-colors"
    ...
    <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
      ...
      <span v-if="!isLoadingGoogle">Continue with Google</span>
    ...
    <div class="mt-6 text-center text-sm text-gray-400">
      ...
      <router-link to="/signup" class="font-medium text-blue-400 hover:text-blue-300 ml-1">
        Sign up
      </router-link>
    </div>
  </div>
...
const signInWithEmail = async () => {
  await authStore.loginEmail(userForm.email, userForm.password);
